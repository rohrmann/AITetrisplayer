...
public class TetrisPlayerTester implements Runnable {
	...
	/*
	 * The number of games to play.. A new thread is spawned for each new game,
	 * so dont go to crazy
	 */
	public static final int TESTS = 1;

	/*
	 * Change to true if you want to show the game (instead of just printing
	 * results). Unless your using a supercomputer, probably don't want to have
	 * TESTS > ~5
	 */
	...
	public static void main(String[] args) {
		...
		System.err.println("MIN: " + min + " MAX: " + max + " AVERAGE: "
				+ average / TESTS);
